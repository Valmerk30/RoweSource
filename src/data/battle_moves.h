...
const struct SignatureMove gSignatureMoveList[NUM_SPECIES] = {
	...
	.modification3 = SIGNATURE_MOD_SECONDARY_EFFECT,
        ...
        .description = _( 
            ...
            "the foe into using attack moves."),
    },	
